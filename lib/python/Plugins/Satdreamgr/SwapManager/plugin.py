...
class SystemToolsSwap(Screen):
    ...
    def __init__(self, session):
        ...
        self['actions'] = ActionMap(['OkCancelActions', 'WizardActions', 'ColorActions'], {'ok': self.go,
         'cancel': self.cancel,
         'red': self.cancel,
         'green': self.go}, -1)
